    ...
    if (event) {
      setFormData({
        ...
        singleTicket: {
          ...
          regularPrice: event.singleTicket?.regularPrice || '',
          maxAvailable: event.singleTicket?.maxAvailable || 100
        },
        doubleTicket: {
          earlyBirdPrice: event.doubleTicket?.earlyBirdPrice || '',
          regularPrice: event.doubleTicket?.regularPrice || '',
          maxAvailable: event.doubleTicket?.maxAvailable || 50
        }
      });
    }
  }, [event]);
